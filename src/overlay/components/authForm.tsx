  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      setDialogProps({
        ...
        message: <>Password reset email sent. Please check your spam folder too.</>,
        confirmText: "OK",
      ...
      setDialogProps({
        title: "Error",
        message: (
          <>Failed to send password reset email. Make sure you typed in a valid email.</>
        ),
        confirmText: "OK",
        onConfirm: () => setDialogProps(null),
      });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (mode === "login") {
      ...
      setDialogProps({
        ...
        message: <>This will kick you out of your game and restarts GFN!</>,
        confirmText: "Yes",
        cancelText: "No",
